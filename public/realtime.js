/* Sincronización en vivo entre dispositivos.
   ...
   datos) después de cada escritura relevante (stock, productos, ventas), y
   acá simplemente reaccionamos volviendo a pedir los datos por la API normal. */
...
async function initRealtime() {
  ...
  try {
    ...
    _rtChannel = _rtClient.channel('app-sync');
...
// callback(table) se dispara cada vez que otro dispositivo cambia una tabla
// relevante ('productos', 'stock_movimientos', 'ventas', ...).
